...
rangy.createModule('DomUtil', function (api, module) {
  ...
  !util.areHostProperties(textNode, [
    'data'
  ]))) {
...
rangy.createModule('DomRange', function (api, module) {
  ...
  var getDocumentOrFragmentContainer = createAncestorFinder([9,
  11]);
  var getReadonlyAncestor = createAncestorFinder(readonlyNodeTypes);
  var getDocTypeNotationEntityAncestor = createAncestorFinder([6,
  10,
  12]);
...
wysihtml5.browser = (function () {
  ...
  function iosVersion(userAgent) {
    return ((/ipad|iphone|ipod/.test(userAgent) && userAgent.match(/ os (\d+).+? like mac os x/)) || [,
    0]) [1];
  }
  return {
...
(function (wysihtml5) {
  ...
  /**
       ...
       */
  IGNORE_URLS_IN = wysihtml5.lang.array(['CODE',
  'PRE',
  'A',
  'SCRIPT',
  'HEAD',
...
wysihtml5.dom.renameElement = function (element, newNodeName) {
  ...
  wysihtml5.dom.copyAttributes(['align',
  'className']).from(element).to(newElement);
...
(function (wysihtml5) {
  ...
  /** @scope wysihtml5.dom.Sandbox.prototype */
  {
    ...
    _getHtml: function (templateVars) {
      ...
      return wysihtml5.lang.string('<!DOCTYPE html><html><head>'
...
(function (wysihtml5) {
  ...
  /** @scope wysihtml5.views.Composer.prototype */
  {
    ...
    isEmpty: function () {
      ...
      this.hasPlaceholderSet() || (this.getTextContent() === '' && !this.element.querySelector(elementsWithVisualValue));
    },
    ...
    _initAutoLinking: function () {
      ...
      var
      // Use a live NodeList to check whether there are any links in the document
