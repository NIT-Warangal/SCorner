...
!function (a, b, c) {
  ...
  o = function () {
    ...
    return i.prototype.preventScrolling = function (a, b) {
      if (this.isActive) if (a.type === f) (b === g && a.originalEvent.detail > 0 || b === u && a.originalEvent.detail < 0) && a.preventDefault();
       else if (a.type === n) {
    ...
    i.prototype.createEvents = function () {
      ...
      this.events = {
        down: function (b) {
          ...
          a.doc.bind(l, a.events[h]).bind(m, a.events[u]),
          !1
        },
        drag: function (b) {
          return a.sliderY = b.pageY - a.$el.offset().top - a.offsetY,
          a.scroll(),
        ...
        up: function () {
          ...
          a.doc.unbind(l, a.events[h]).unbind(m, a.events[u]),
          !1
        },
        resize: function () {
          a.reset()
        ...
        panedown: function (b) {
          return a.sliderY = (b.offsetY || b.originalEvent.layerY) - 0.5 * a.sliderHeight,
          a.scroll(),
          a.events.down(b),
          !1
        },
    ...
    i.prototype.removeEvents = function () {
      ...
      this.$content.unbind('' + r + ' ' + n + ' ' + f + ' ' + t, a[r])
    },
    i.prototype.generate = function () {
      ...
      this.pane = this.$el.children('.' + d),
      this.slider = this.pane.find('.' + f),
      e && (b = {
        right: - e
    ...
    i.prototype.destroy = function () {
      ...
      this.pane.length && this.pane.remove(),
  ...
  a.fn.nanoScroller = function (b) {
    return this.each(function () {
      ...
      }, w, b), this.nanoscroller = d = new o(this, c)), b && 'object' == typeof b) {
