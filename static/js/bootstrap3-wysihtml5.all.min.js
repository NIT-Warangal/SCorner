...
window.rangy = function () {
  ...
  s.warn = function (a) {
    a = 'Rangy warning: ' + a,
    s.config.alertOnWarn ? window.alert(a)  : typeof window.console != k && typeof window.console.log != k && window.console.log(a)
  },
  {
  ...
  if (typeof window == k) f('No window found');
    ...
    if (typeof document != k) return a(document, 'addEventListener') && document.addEventListener('DOMContentLoaded', q, !1),
    a(window, 'addEventListener') ? window.addEventListener('load', q, !1)  : a(window, 'attachEvent') ? window.attachEvent('onload', q)  : f('Window does not have required addEventListener or attachEvent method'),
    s;
    f('No document found')
  }
}(),
rangy.createModule('DomUtil', function (a, b) {
  ...
  var m = 'undefined',
  n = a.util;
  n.areHostMethods(document, [
    'createDocumentFragment',
    'createElement',
    'createTextNode'
  ]) || b.fail('document missing a Node creation method'),
  n.isHostMethod(document, 'getElementsByTagName') || b.fail('document missing getElementsByTagName method');
  ...
  n.isHostProperty(o, 'innerHTML') || b.fail('Element is missing innerHTML property'),
...
rangy.createModule('DomRange', function (a) {
  ...
  function d(a, b, c) {
    if (b = a._listeners[b]) for (var d = 0, e = b.length; e > d; ++d) b[d].call(a, {
      target: a,
      args: c
    })
  }
  ...
  function g(a, b, c) {
    ...
    return H.isCharacterDataNode(b) ? c == b.length ? H.insertAfter(a, b)  : b.parentNode.insertBefore(a, 0 == c ? b : H.splitDataNode(b, c))  : c >= b.childNodes.length ? b.appendChild(a)  : b.insertBefore(a, b.childNodes[c]),
    d
  }
  function h(a) {
  ...
  function i(a, b, c) {
    for (var d, e, c = c || {
      stop: !1
    }; d = a.next(); ) if (a.isPartiallySelectedSubtree()) {
      if (!1 === b(d)) {
        c.stop = !0;
        break
      }
  ...
  function C(a, b) {
    return function () {
      ...
      g = new n(this, !0);
      return c !== e && (c = H.getClosestAncestorIn(c, e, !0), d = f(c), c = d.node, d = d.offset),
      i(g, w),
      g.reset(),
      e = a(g),
      g.detach(),
  ...
  function D(c, d, g) {
    ...
    a.util.extend(c.prototype, {
      ...
      selectNodeContents: function (a) {
        s(this),
        r(a, !0),
        d(this, a, 0, a, H.getNodeLength(a))
      },
      ...
      splitBoundaries: function () {
        ...
        e = this.endOffset,
        f = a === c;
        H.isCharacterDataNode(c) && e > 0 && e < c.length && H.splitDataNode(c, e),
        H.isCharacterDataNode(a) && b > 0 && b < a.length && (a = H.splitDataNode(a, b), f ? (e -= b, c = a)  : c == a.parentNode && e >= H.getNodeIndex(a) && e++, b = 0),
        d(this, a, b, c, e)
      },
      normalizeBoundaries: function () {
        ...
        g = function (d) {
          ...
          if (f && f.nodeType == d.nodeType) {
            ...
            a == c ? (e += b, c = a)  : c == d.parentNode && (f = H.getNodeIndex(d), e == f ? (c = d, e = g)  : e > f && e--)
          }
        },
        h = !0;
        H.isCharacterDataNode(c) ? c.length == e && f(c)  : (e > 0 && (h = c.childNodes[e - 1]) && H.isCharacterDataNode(h) && f(h), h = !this.collapsed),
        h ? H.isCharacterDataNode(a) ? 0 == b && g(a)  : b < a.childNodes.length && (f = a.childNodes[b]) && H.isCharacterDataNode(f) && g(f)  : (a = c, b = e),
        d(this, a, b, c, e)
      },
  ...
  function E(a) {
    ...
    a.commonAncestorContainer = a.collapsed ? a.startContainer : H.getCommonAncestor(a.startContainer, a.endContainer)
  }
  ...
  n.prototype = {
    ...
    next: function () {
      ...
      return a && (this._next = a !== this._last ? a.nextSibling : null, H.isCharacterDataNode(a) && this.clonePartiallySelectedTextNodes && (a === this.ec && (a = a.cloneNode(!0)).deleteData(this.eo, a.length - this.eo), this._current === this.sc && (a = a.cloneNode(!0)).deleteData(0, this.so))),
      a
    },
    remove: function () {
      var a,
    ...
    getSubtreeIterator: function () {
      ...
      a.collapse();
        ...
        f = b,
        g = H.getNodeLength(b);
        H.isAncestorOf(b, this.sc, !0) && (d = this.sc, e = this.so),
        H.isAncestorOf(b, this.ec, !0) && (f = this.ec, g = this.eo),
        F(a, d, e, f, g)
      }
  ...
  z.prototype = {
    ...
    cloneRange: function () {
      y(this);
      for (var a, b = new G(c(this)), d = V.length; d--; ) a = V[d],
      b[a] = this[a];
      return b
    },
    toString: function () {
    ...
    compareNode: function (a) {
      ...
      return a = this.comparePoint(b, c),
    ...
    comparePoint: function (a, b) {
      ...
      0 > H.comparePoints(a, b, this.startContainer, this.startOffset) ? - 1 : 0 < H.comparePoints(a, b, this.endContainer, this.endOffset) ? 1 : 0
    },
    createContextualFragment: T ? function (a) {
      ...
      var d = null;
      return 1 == b.nodeType ? d = b : H.isCharacterDataNode(b) && (d = H.parentElement(b)),
      d = null === d || 'HTML' == d.nodeName && H.isHtmlNamespace(H.getDocument(d).documentElement) && H.isHtmlNamespace(d) ? c.createElement('body')  : d.cloneNode(!1),
      d.innerHTML = a,
      H.fragmentFromNodeChildren(d)
    }
     : function (a) {
      s(this);
      var b = c(this).createElement('body');
      return b.innerHTML = a,
      H.fragmentFromNodeChildren(b)
    },
    toHtml: function () {
      y(this);
    ...
    isPointInRange: function (a, b) {
      ...
      x(a, 'HIERARCHY_REQUEST_ERR'),
      v(a, this.startContainer),
      0 <= H.comparePoints(a, b, this.startContainer, this.startOffset) && 0 >= H.comparePoints(a, b, this.endContainer, this.endOffset)
    },
    ...
    union: function (a) {
      if (this.intersectsRange(a, !0)) {
        ...
        return - 1 == H.comparePoints(a.startContainer, a.startOffset, this.startContainer, this.startOffset) && b.setStart(a.startContainer, a.startOffset),
        1 == H.comparePoints(a.endContainer, a.endOffset, this.endContainer, this.endOffset) && b.setEnd(a.endContainer, a.endOffset),
        b
      }
  ...
  a.rangePrototype = z.prototype,
  G.rangeProperties = V,
  G.RangeIterator = n,
  G.copyComparisonConstants = B,
  G.createPrototypeRange = D,
  G.inspect = m,
  G.getRangeDocument = c,
  G.rangesEqual = function (a, b) {
...
rangy.createModule('WrappedRange', function (a) {
  function b(a, b, c, d) {
    ...
    var i,
    b = e.getDocument(h).createElement('span'),
    j = c ? 'StartToStart' : 'StartToEnd';
    do h.insertBefore(b, b.previousSibling),
    g.moveToElementText(b);
    while (0 < (i = g.compareEndPoints(j, a)) && b.previousSibling);
    if (j = b.nextSibling, - 1 == i && j && e.isCharacterDataNode(j)) {
      if (g.setEndPoint(c ? 'EndToStart' : 'EndToEnd', a), /[\r\n]/.test(j.data)) for (h = g.duplicate(), c = h.text.replace(/\r\n/g, '\r').length, c = h.moveStart('character', c); - 1 == h.compareEndPoints('StartToEnd', h); ) c++,
      h.moveStart('character', 1);
       else c = g.text.length;
      h = new f(j, c)
    } else j = (d || !c) && b.previousSibling,
    h = (c = (d || c) && b.nextSibling) && e.isCharacterDataNode(c) ? new f(c, 0)  : j && e.isCharacterDataNode(j) ? new f(j, j.length)  : new f(h, e.getNodeIndex(b));
  ...
  function c(a, b) {
    ...
    return i ? (c = a.node, d = c.parentNode)  : (c = a.node.childNodes, c = f < c.length ? c[f] : null, d = a.node),
    ...
    h.collapse(!b),
    d.removeChild(g),
    i && h[b ? 'moveStart' : 'moveEnd']('character', f),
    h
  }
  a.requireModules(['DomUtil',
  'DomRange']);
  ...
  if (!a.features.implementsDomRange || a.features.implementsTextRange && a.config.preferTextRange) {
    if (a.features.implementsTextRange) {
      ...
      d.prototype.refresh = function () {
        ...
        f.collapse(!1),
        d = f.parentElement(),
        c = c == d ? c : e.getCommonAncestor(c, d),
        c = c == a ? c : e.getCommonAncestor(a, c),
        0 == this.textRange.compareEndPoints('StartToEnd', this.textRange) ? c = a = b(this.textRange, c, !0, !0)  : (a = b(this.textRange, c, !0, !1), c = b(this.textRange, c, !1, !1)),
      ...
      'undefined' == typeof h.Range && (h.Range = d),
    ...
    c.selectNodeContents = j.startContainer == i && j.endContainer == i && 0 == j.startOffset && j.endOffset == i.length ? function (a) {
    ...
    f.setEnd(i, 4),
    f.setStart(i, 2),
    c.compareBoundaryPoints = - 1 == j.compareBoundaryPoints(j.START_TO_END, f) & 1 == j.compareBoundaryPoints(j.END_TO_START, f) ? function (a, b) {
  ...
  a.features.implementsTextRange && (d.rangeToTextRange = function (a) {
    ...
    return a.setEndPoint('StartToStart', b),
  ...
  a.addCreateMissingNativeApiListener(function (b) {
    b = b.document,
    'undefined' == typeof b.createRange && (b.createRange = function () {
...
rangy.createModule('WrappedSelection', function (a, b) {
  ...
  function g(b) {
    ...
    })))  : b instanceof u ? c = b.nativeRange : a.features.implementsDomRange && b instanceof r.getWindow(b.startContainer).Range && (c = b),
    c
  }
  function h(a) {
    var b,
  ...
  function j(b) {
    if (b._ranges.length = 0, 'None' == b.docSelection.type) f(b);
      ...
      if (c && 'undefined' != typeof c.text) i(b, c);
        ...
        for (var d, g = r.getDocument(c.item(0)), h = 0; h < b.rangeCount; ++h) d = a.createRange(g),
  ...
  a.getNativeSelection = p;
  var x = p(),
  A = a.createNativeRange(document),
  B = r.getBody(document),
  C = s.areHostObjects(x, s.areHostProperties(x, [
    'anchorOffset',
    'focusOffset'
  ]));
  ...
  s.areHostMethods(x, [
    ...
    'getRangeAt',
    'removeAllRanges'
  ]) && 'number' == typeof x.rangeCount && a.features.implementsDomRange && function () {
  ...
  a.features.selectionSupportsMultipleRanges = F,
  a.features.collapsedNonEditableSelectionsSupported = G;
  var H,
  I = !1;
  B && s.isHostMethod(B, 'createControlRange') && (H = B.createControlRange(), s.areHostProperties(H, [
    'item',
    'add'
  ]) && (I = !0)),
  a.features.implementsControlRange = I,
  q = C ? function (a) {
  ...
  if (s.isHostMethod(x, 'getRangeAt') ? J = function (a, b) {
   ...
   : C && (J = function (b) {
    ...
    c = a.createRange(c);
    return c.setStart(b.anchorNode, b.anchorOffset),
    c.setEnd(b.focusNode, b.focusOffset),
    c.collapsed !== this.isCollapsed && (c.setStart(b.focusNode, b.focusOffset), c.setEnd(b.anchorNode, b.anchorOffset)),
    c
    ...
    c = p(a),
    e = y ? d(a)  : null;
    return b ? (b.nativeSelection = c, b.docSelection = e, b.refresh(a))  : (b = new l(c, e, a), a._rangySelection = b),
    b
  }, a.getIframeSelection = function (b) {
    return a.getSelection(r.getIframeWindow(b))
  }, H = l.prototype, !z && C && s.areHostMethods(x, [
    'removeAllRanges',
    'addRange'
  ])) {
    ...
    var K = function (b, c) {
      ...
      b.nativeSelection.addRange(g(d)),
    ...
    H.addRange = E ? function (b, c) {
      if (I && y && 'Control' == this.docSelection.type) k(this, b);
        ...
        var d;
        F ? d = this.rangeCount : (this.removeAllRanges(), d = 0),
        this.nativeSelection.addRange(g(b)),
        this.rangeCount = this.nativeSelection.rangeCount,
        this.rangeCount == d + 1 ? (a.config.checkSelectionRanges && (d = J(this.nativeSelection, this.rangeCount - 1)) && !t.rangesEqual(d, b) && (b = new u(d)), this._ranges[this.rangeCount - 1] = b, e(this, b, N(this.nativeSelection)), this.isCollapsed = q(this))  : this.refresh()
      }
    }
     : function (a, b) {
    ...
    if (!(s.isHostMethod(x, 'empty') && s.isHostMethod(A, 'select') && I && z)) return b.fail('No means of selecting a Range or TextRange was found'),
    !1;
    H.removeAllRanges = function () {
      try {
  ...
  if (z) L = function (b) {
    var c;
    a.isSelectionValid(b.win) ? c = b.docSelection.createRange()  : (c = r.getBody(b.win.document).createTextRange(), c.collapse(!0)),
    'Control' == b.docSelection.type ? j(b)  : c && 'undefined' != typeof c.text ? i(b, c)  : f(b)
  };
    ...
    if (I && y && 'Control' == b.docSelection.type) j(b);
      ...
      e(b, b._ranges[b.rangeCount - 1], N(b.nativeSelection)),
      b.isCollapsed = q(b)
    } else f(b)
  };
   else {
    if (!C || 'boolean' != typeof x.isCollapsed || 'boolean' != typeof A.collapsed || !a.features.implementsDomRange) return b.fail('No means of obtaining a Range or TextRange from the user\'s selection was found'),
    !1;
    L = function (a) {
      var b;
      b = a.nativeSelection,
      b.anchorNode ? (b = J(b, 0), a._ranges = [
        b
      ], a.rangeCount = 1, b = a.nativeSelection, a.anchorNode = b.anchorNode, a.anchorOffset = b.anchorOffset, a.focusNode = b.focusNode, a.focusOffset = b.focusOffset, a.isCollapsed = q(a))  : f(a)
    }
  }
  ...
  H.removeRange = I ? function (a) {
    if ('Control' == this.docSelection.type) {
      for (var b, c = this.docSelection.createRange(), a = h(a), d = r.getDocument(c.item(0)), d = r.getBody(d).createControlRange(), e = !1, f = 0, g = c.length; g > f; ++f) b = c.item(f),
      b !== a || e ? d.add(c.item(f))  : e = !0;
      d.select(),
      j(this)
    } else M(this, a)
  }
  ...
  !z && C && a.features.implementsDomRange ? (N = function (a) {
    var b = !1;
    return a.anchorNode && (b = 1 == r.comparePoints(a.anchorNode, a.anchorOffset, a.focusNode, a.focusOffset)),
    b
  ...
  H.toString = function () {
    for (var a = [
    ], b = 0, c = this.rangeCount; c > b; ++b) a[b] = '' + this._ranges[b];
    return a.join('')
  },
  ...
  H.deleteFromDocument = function () {
    if (I && y && 'Control' == this.docSelection.type) {
      for (var a, b = this.docSelection.createRange(); b.length; ) a = b.item(0),
      b.remove(a),
  ...
  extend: function (a, b) {
    if (1 < arguments.length) {
      ...
      for (var f = {
        ...
        'toString',
        'valueOf'
      ], h = Base._prototyping ? 0 : 1; i = g[h++]; ) a[i] != f[i] && e.call(this, i, a[i]);
...
wysihtml5.browser = function () {
  ...
  return {
    ...
    supported: function () {
      ...
      a = this.isIos() && 5 > (/ipad|iphone|ipod/.test(a) && a.match(/ os (\d+).+? like mac os x/) || [,
      0]) [1] || - 1 !== a.indexOf('opera mobi') || - 1 !== a.indexOf('hpwos/');
      return c && d && e && !a
    },
    ...
    supportsEvent: function (a) {
      var c;
      return (c = 'on' + a in b) || (b.setAttribute('on' + a, 'return;'), c = 'function' == typeof b['on' + a]),
      c
    },
    ...
    supportsHTML5Tags: function (a) {
      ...
      '<article>foo</article>' === a.innerHTML.toLowerCase()
    },
    ...
    autoClosesUnclosedTags: function () {
      ...
      c = c.innerHTML.toLowerCase(),
      a = '<p></p><div></div>' === c || '<p><div></div></p>' === c,
    ...
    supportsSpeechApiOn: function (b) {
      return 11 <= (a.match(/Chrome\/(\d+)/) || [,
      0]) [1] && ('onwebkitspeechchange' in b || 'speech' in b)
    },
...
wysihtml5.lang.array = function (a) {
  return {
    ...
    without: function (b) {
      for (var b = wysihtml5.lang.array(b), c = [
      ], d = 0, e = a.length; e > d; d++) b.contains(a[d]) || c.push(a[d]);
      return c
    },
    get: function () {
...
wysihtml5.lang.Dispatcher = Base.extend({
  ...
  stopObserving: function (a, b) {
    ...
    e = 0;
    if (a) {
      for (c = this.events[a] || [], d = [
      ]; e < c.length; e++) c[e] !== b && b && d.push(c[e]);
      this.events[a] = d
    } else this.events = {
    };
    return this
...
function (a) {
  function b(a) {
    return a.replace(e, function (a, b) {
      ...
      var e = d = b;
      return b.length > g && (e = e.substr(0, g) + '...'),
...
wysihtml5.dom.convertToList = function () {
  ...
  return function (b, c) {
    ...
    for (k = wysihtml5.lang.array(b.childNodes).get(), l = k.length, h = 0; l > h; h++) g = g || a(i, j),
    d = k[h],
    e = 'block' === wysihtml5.dom.getStyle('display').from(d),
    f = 'BR' === d.nodeName,
    e ? (g = g.firstChild ? a(i, j)  : g, g.appendChild(d), g = null)  : f ? g = g.firstChild ? null : g : g.appendChild(d);
    return b.parentNode.replaceChild(j, b),
    j
  }
}(),
wysihtml5.dom.copyAttributes = function (a) {
  return {
    from: function (b) {
      return {
        to: function (c) {
          for (var d, e = 0, f = a.length; f > e; e++) d = a[e],
          'undefined' != typeof b[d] && '' !== b[d] && (c[d] = b[d]);
          return {
  ...
  a.copyStyles = function (d) {
    return {
      from: function (e) {
        ...
        for (var f, g = '', h = d.length, i = 0; h > i; i++) f = d[i],
...
wysihtml5.dom.getAsDom = function () {
  ...
  return function (b, c) {
    var d,
    c = c || document;
    if ('object' == typeof b && b.nodeType) d = c.createElement('div'),
    d.appendChild(b);
     else if (wysihtml5.browser.supportsHTML5Tags(c)) d = c.createElement('div'),
    d.innerHTML = b;
     else {
    ...
    return {
      from: function (d) {
        if (d.nodeType === wysihtml5.ELEMENT_NODE) {
          ...
          if (f.getComputedStyle) return e && (k = g.overflow, g.overflow = 'hidden'),
          d = f.getComputedStyle(d, null).getPropertyValue(c),
          e && (g.overflow = k || ''),
          d
        }
      }
...
wysihtml5.dom.hasElementWithTagName = function () {
  ...
  return function (c, d) {
    ...
    f = a[e];
    return f || (f = a[e] = c.getElementsByTagName(d)),
    0 < f.length
  }
}(),
function (a) {
  ...
  a.dom.hasElementWithClassName = function (d, e) {
    ...
    g = b[f];
    return g || (g = b[f] = d.getElementsByClassName(e)),
    0 < g.length
  }
}(wysihtml5),
...
wysihtml5.dom.observe = function (a, b, c) {
  for (var d, e, b = 'string' == typeof b ? [
    b
  ] : b, f = 0, g = b.length; g > f; f++) e = b[f],
  ...
  return {
    stop: function () {
      for (var e, f = 0, g = b.length; g > f; f++) e = b[f],
...
wysihtml5.dom.parse = function () {
  ...
  var c = {
    1: function (a) {
      ...
      for (o['_wysihtml5-temp-placeholder'] = 1, (t = a.getAttribute('class')) && (q = q.concat(t.split(e))), l = q.length; l > p; p++) a = q[p],
      o[a] && c.push(a);
      for (o = c.length; o--; ) a = c[o],
      wysihtml5.lang.array(s).contains(a) || s.unshift(a);
      s.length && (h['class'] = s.join(' '));
      for (r in h) try {
        f.setAttribute(r, h[r])
      } catch (u) {
      }
      return h.src && ('undefined' != typeof h.width && f.setAttribute('width', h.width), 'undefined' != typeof h.height && f.setAttribute('height', h.height)),
      f
    },
    3: function (a) {
  ...
  return function (b, c, d, e) {
    ...
    for (var d = d || b.ownerDocument || document, c = d.createDocumentFragment(), h = 'string' == typeof b, b = h ? wysihtml5.dom.getAsDom(b, d)  : b; b.firstChild; ) d = b.firstChild,
    b.removeChild(d),
    (d = a(d, e)) && c.appendChild(d);
    return b.innerHTML = '',
    b.appendChild(c),
    h ? wysihtml5.quirks.getCorrectInnerHTML(b)  : b
  }
}(),
wysihtml5.dom.removeEmptyTextNodes = function (a) {
  for (var b = wysihtml5.lang.array(a.childNodes).get(), c = b.length, d = 0; c > d; d++) a = b[d],
  a.nodeType === wysihtml5.TEXT_NODE && '' === a.data && a.parentNode.removeChild(a)
},
wysihtml5.dom.renameElement = function (a, b) {
  for (var c, d = a.ownerDocument.createElement(b); c = a.firstChild; ) d.appendChild(c);
  return wysihtml5.dom.copyAttributes(['align',
  'className']).from(a).to(d),
...
function (a) {
  ...
  a.resolveList = function (c) {
    if ('MENU' === c.nodeName || 'UL' === c.nodeName || 'OL' === c.nodeName) {
      ...
      e,
      f,
      g = c.ownerDocument.createDocumentFragment(),
      h = c.previousElementSibling || c.previousSibling;
      for (h && 'block' !== a.getStyle('display').from(h) && b(g); f = c.firstChild; ) {
        for (d = f.lastChild; h = f.firstChild; ) e = (e = h === d) && 'block' !== a.getStyle('display').from(h) && 'BR' !== h.nodeName,
        g.appendChild(h),
        e && b(g);
        f.parentNode.removeChild(f)
      }
  ...
  a.dom.Sandbox = Base.extend({
    ...
    _getHtml: function (b) {
      ...
      if (d = 'string' == typeof d ? [
        d
      ] : d) for (c = d.length; c > f; f++) e += '<link rel="stylesheet" href="' + d[f] + '">';
  ...
  return {
    on: function (b) {
      if (b = b.style, 'string' == typeof a) b.cssText += ';' + a;
       else for (var c in a) 'float' === c ? (b.cssFloat = a[c], b.styleFloat = a[c])  : b[c] = a[c]
    }
  }
},
function (a) {
  a.simulatePlaceholder = function (b, c, d) {
    var e = function () {
      ...
      a.removeClass(c.element, 'placeholder')
    },
    f = function () {
      c.isEmpty() && (c.setValue(d), a.addClass(c.element, 'placeholder'))
    };
    b.observe('set_placeholder', f).observe('unset_placeholder', e).observe('focus:composer', e).observe('paste:composer', e).observe('blur:composer', f),
    f()
  }
}(wysihtml5.dom),
function (a) {
...
function (a) {
  a.quirks.getCorrectInnerHTML = function (b) {
    ...
    f,
    g,
    b = b.querySelectorAll('[href*=\'~\'], [src*=\'~\']');
    for (g = 0, f = b.length; f > g; g++) d = b[g].href || b[g].src,
    e = a.lang.string(d).replace('~').by('%7E'),
    c = a.lang.string(c).replace(e).by(d);
    return c
  }
}(wysihtml5),
function (a) {
...
function (a) {
  a.quirks.redraw = function (b) {
    a.dom.addClass(b, 'wysihtml5-quirks-redraw'),
    a.dom.removeClass(b, 'wysihtml5-quirks-redraw');
    try {
      var c = b.ownerDocument;
      c.execCommand('italic', !1, null),
      c.execCommand('italic', !1, null)
    } catch (d) {
    }
  }
...
function (a) {
  ...
  a.Selection = Base.extend({
    ...
    selectNode: function (c) {
      ...
      f && g && e ? d.collapse(h)  : f && g && (d.setStartAfter(c), d.setEndAfter(c)),
      this.setSelection(d)
    },
    ...
    executeAndRestore: function (b, c) {
      ...
      if (h) {
        g = h.createContextualFragment(g),
        h.insertNode(g);
        try {
        ...
        }(caretPlaceholder = this.doc.querySelector('._wysihtml5-temp-placeholder')) ? (h = rangy.createRange(this.doc), h.selectNode(caretPlaceholder), h.deleteContents(), this.setSelection(h))  : d.focus(),
    ...
    executeAndRestoreSimple: function (a) {
      ...
      if (e) {
        b = e.getNodes([3]),
        f = b[0] || e.startContainer,
        d = b[b.length - 1] || e.endContainer,
        b = f === e.startContainer ? e.startOffset : 0,
        c = d === e.endContainer ? e.endOffset : d.length;
        try {
    ...
    scrollIntoView: function () {
      ...
      if ((b = c._wysihtml5ScrollIntoViewElement) || (b = c.createElement('span'), b.innerHTML = a.INVISIBLE_SPACE), b = c._wysihtml5ScrollIntoViewElement = b, d) {
        ...
        d > c.body.scrollTop && (c.body.scrollTop = d)
      }
    },
    selectLine: function () {
...
function (a, b) {
  ...
  function e(b) {
    this.firstTextNode = (this.isElementMerge = b.nodeType == a.ELEMENT_NODE) ? b.lastChild : b,
    this.textNodes = [
      this.firstTextNode
    ]
  }
  ...
  e.prototype = {
    doMerge: function () {
      for (var a, b, c = [
      ], d = 0, e = this.textNodes.length; e > d; ++d) a = this.textNodes[d],
      b = a.parentNode,
      c[d] = a.data,
    ...
    toString: function () {
      for (var a = [
      ], b = 0, c = this.textNodes.length; c > b; ++b) a[b] = '\'' + this.textNodes[b].data + '\'';
      return '[Merge(' + a.join(',') + ')]'
    }
  },
  f.prototype = {
    ...
    postApply: function (a, b) {
      for (var c, d, f, g = a[0], h = a[a.length - 1], i = [
      ], j = g, k = h, l = 0, m = h.length, n = 0, o = a.length; o > n; ++n) d = a[n],
      (f = this.getAdjacentMergeableTextNode(d.parentNode, !1)) ? (c || (c = new e(f), i.push(c)), c.textNodes.push(d), d === g && (j = c.firstTextNode, l = j.length), d === h && (k = c.firstTextNode, m = c.getLength()))  : c = null;
    ...
    createContainer: function (a) {
      return a = a.createElement(this.tagNames[0]),
    ...
    applyToRange: function (b) {
      ...
      if (!c.length) try {
        ...
        return b.surroundContents(d),
        void this.selectNode(b, d)
      } catch (e) {
      }
      if (b.splitBoundaries(), c = b.getNodes([a.TEXT_NODE]), c.length) {
        for (var f = 0, g = c.length; g > f; ++f) d = c[f],
        this.getAncestorWithClass(d) || this.applyToTextNode(d);
        b.setStart(c[0], 0),
        d = c[c.length - 1],
        b.setEnd(d, d.length),
    ...
    undoToRange: function (b) {
      ...
      e.length ? (b.splitBoundaries(), e = b.getNodes([a.TEXT_NODE]))  : (e = b.endContainer.ownerDocument.createTextNode(a.INVISIBLE_SPACE), b.insertNode(e), b.selectNode(e), e = [
        e
      ]);
      for (var f = 0, g = e.length; g > f; ++f) c = e[f],
      (d = this.getAncestorWithClass(c)) && this.undoToTextNode(c, b, d);
    ...
    selectNode: function (b, c) {
      ...
      f && d ? b.collapse(!1)  : f && (b.setStartAfter(c), b.setEndAfter(c))
    },
    ...
    isAppliedToRange: function (b) {
      ...
      e = b.getNodes([a.TEXT_NODE]);
      if (!e.length) return (c = this.getAncestorWithClass(b.startContainer)) ? [
        c
      ] : !1;
...
function (a) {
  function b(b, f) {
    ...
    l = h,
    1 === k && (i = e.getTextContent(h), k = !!h.querySelector('*'), i = '' === i || i === a.INVISIBLE_SPACE, !k && i && (e.setTextContent(h, f.text || h.href), j = j.createTextNode(' '), b.selection.setAfter(h), b.selection.insertNode(j), l = j)),
  ...
  a.commands.createLink = {
    exec: function (a, c, d) {
      ...
      f ? a.selection.executeAndRestore(function () {
        for (var a, b, c, d = f.length, g = 0; d > g; g++) a = f[g],
        b = e.getParentElement(a, {
          nodeName: 'code'
        }),
        c = e.getTextContent(a),
        c.match(e.autoLink.URL_REG_EXP) && !b ? e.renameElement(a, 'code')  : e.replaceWithChildNodes(a)
      })  : (d = 'object' == typeof d ? d : {
        href: d
      }, b(a, d))
    },
...
function (a) {
  ...
  a.commands.formatBlock = {
    ...
    state: function (a, b, c, d, e) {
      return c = 'string' == typeof c ? c.toUpperCase()  : c,
      a = a.selection.getSelectedNode(),
      g.getParentElement(a, {
        nodeName: c,
        className: d,
        classRegExp: e
      })
...
function (a) {
  a.commands.insertImage = {
    exec: function (b, c, d) {
      ...
      f = b.doc,
      c = this.state(b);
      if (c) b.selection.setBefore(c),
      d = c.parentNode,
      d.removeChild(c),
      a.dom.removeEmptyTextNodes(d),
      'A' === d.nodeName && !d.firstChild && (b.selection.setAfter(d), d.parentNode.removeChild(d)),
      a.quirks.redraw(b.element);
       else {
        c = f.createElement('IMG');
        for (e in d) c[e] = d[e];
        b.selection.insertNode(c),
        a.browser.hasProblemsSettingCaretAfterImg() ? (d = f.createTextNode(a.INVISIBLE_SPACE), b.selection.insertNode(d), b.selection.setAfter(d))  : b.selection.setAfter(c)
      }
    },
    state: function (b) {
      var c;
...
function (a) {
  a.commands.insertOrderedList = {
    ...
    state: function (b) {
      return b = b.selection.getSelectedNode(),
      a.dom.getParentElement(b, {
        nodeName: 'OL'
      })
    },
    value: function () {
      ...
      if (d.observe(this.element, 'keydown', function (a) {
        ...
        d.observe(this.element, 'contextmenu', function () {
          ...
          f.composer.selection.executeAndRestoreSimple(function () {
            ...
            g.execCommand('insertHTML', !1, b),
            g.execCommand('insertHTML', !1, c),
            g.execCommand('undo', !1, null)
          }),
          h = setInterval(function () {
            g.getElementById('_wysihtml5-redo') ? (j(), f.redo())  : g.getElementById('_wysihtml5-undo') || (j(), f.undo())
          }, 400),
          i || (i = !0, d.observe(document, 'mousedown', j), d.observe(g, [
            'mousedown',
            'paste',
            'cut',
            'copy'
...
function (a) {
  ...
  a.views.Composer = a.views.View.extend({
    ...
    _create: function () {
      ...
      b.copyAttributes('className spellcheck title lang dir accessKey'.split(' ')).from(this.textarea.element).to(this.element),
      ...
      (e = 'string' == typeof this.config.placeholder ? this.config.placeholder : this.textarea.element.getAttribute('placeholder')) && b.simulatePlaceholder(this.parent, this, e),
    ...
    _initAutoLinking: function () {
      ...
      if (e && this.commands.exec('autoUrlDetect', !1), this.config.autoLink) {
        ...
        i = function (c) {
          return c = a.lang.string(b.getTextContent(c)).trim(),
        ...
        b.observe(this.element, 'keydown', function (a) {
          if (g.length) {
            var c,
            a = d.selection.getSelectedNode(a.target.ownerDocument),
    ...
    _initObjectResizing: function () {
      ...
      this.config.allowObjectResizing ? c.supportsEvent('resizeend') && b.observe(f, 'resizeend', function (b) {
        for (var c, b = b.target || b.srcElement, g = b.style, h = 0; e > h; h++) c = d[h],
        g[c] && (b.setAttribute(c, parseInt(g[c], 10)), g[c] = '');
        a.quirks.redraw(f)
...
function (a) {
  ...
  i = [
    ...
    a.browser.isGecko ? 'body.placeholder { color: graytext !important; }' : 'body.placeholder { color: #a9a9a9 !important; }',
...
function (a) {
  ...
  a.views.Composer.prototype.observe = function () {
    ...
    c.firesOnDropOnlyWhenOnDragOverIsCancelled() && b.observe(h, [
      'dragover',
      'dragenter'
    ], function (a) {
      a.preventDefault()
    ...
    b.observe(h, j, function (a) {
      var b,
      d = a.dataTransfer;
      d && c.supportsDataTransfer() && (b = d.getData('text/html') || d.getData('text/plain')),
      b ? (h.focus(), e.commands.exec('insertHTML', b), e.parent.fire('paste').fire('paste:composer'), a.stopPropagation(), a.preventDefault())  : setTimeout(function () {
        e.parent.fire('paste').fire('paste:composer')
      }, 0)
    }),
    b.observe(h, 'keyup', function (b) {
      b = b.keyCode,
      (b === a.SPACE_KEY || b === a.ENTER_KEY) && e.parent.fire('newword:composer')
    }),
...
function (a) {
  a.views.Synchronizer = Base.extend({
    ...
    _observe: function () {
      ...
      e(),
      d && (a.dom.observe(d, 'submit', function () {
        c.sync(!0)
...
wysihtml5.views.Textarea = wysihtml5.views.View.extend({
  ...
  _observe: function () {
    ...
    d = wysihtml5.browser.supportsEvent('focusin') ? [
      'focusin',
      'focusout',
      'change'
    ] : [
    ...
    b.observe('beforeload', function () {
      wysihtml5.dom.observe(a, d, function (a) {
        a = c[a.type] || a.type,
        b.fire(a).fire(a + ':textarea')
      }),
      wysihtml5.dom.observe(a, [
        'paste',
        'drop'
      ], function () {
        setTimeout(function () {
  ...
  a.toolbar.Dialog = a.lang.Dispatcher.extend({
    ...
    _observe: function () {
      if (!this._observed) {
        ...
        d = function (a) {
          var b = c._serialize();
          b == c.elementToChange ? c.fire('edit', b)  : c.fire('save', b),
          c.hide(),
          a.preventDefault(),
          a.stopPropagation()
        };
        ...
        b.observe(this.container, 'keydown', function (b) {
          var e = b.keyCode;
          e === a.ENTER_KEY && d(b),
          e === a.ESCAPE_KEY && c.hide()
        }),
        b.delegate(this.container, '[data-wysihtml5-dialog-action=save]', 'click', d),
    ...
    _serialize: function () {
      ...
      }, b = this.container.querySelectorAll('[data-wysihtml5-dialog-field]'), c = b.length, d = 0; c > d; d++) a[b[d].getAttribute('data-wysihtml5-dialog-field')] = b[d].value;
      return a
    },
    _interpolate: function (a) {
      for (var b, c, d = document.querySelector(':focus'), e = this.container.querySelectorAll('[data-wysihtml5-dialog-field]'), f = e.length, g = 0; f > g; g++) b = e[g],
      b !== d && !(a && 'hidden' === b.type) && (c = b.getAttribute('data-wysihtml5-dialog-field'), c = this.elementToChange ? this.elementToChange[c] || '' : b.defaultValue, b.value = c)
    },
    show: function (a) {
      var c = this,
    ...
    hide: function () {
      ...
      b.removeClass(this.link, 'wysihtml5-command-dialog-opened'),
...
function (a) {
  ...
  a.toolbar.Speech = function (g, h) {
    ...
    if (a.browser.supportsSpeechApiOn(i)) {
      ...
      b.setStyles(d).on(j),
      b.setStyles(c).on(h),
      b.observe(i, 'onwebkitspeechchange' in i ? 'webkitspeechchange' : 'speechchange', function () {
...
function (a) {
  ...
  a.toolbar.Toolbar = Base.extend({
    ...
    _getLinks: function (b) {
      for (var c, d, e, f, g, h = this[b + 'Links'] = a.lang.array(this.container.querySelectorAll('[data-wysihtml5-' + b + ']')).get(), i = h.length, j = 0, k = this[b + 'Mapping'] = {
      }; i > j; j++) c = h[j],
    ...
    _observe: function () {
      ...
      c.observe('change_view', function (c) {
        setTimeout(function () {
          a.commandsDisabled = 'composer' !== c,
          a._updateLinkStates(),
          a.commandsDisabled ? b.addClass(d, 'wysihtml5-commands-disabled')  : b.removeClass(d, 'wysihtml5-commands-disabled')
        }, 0)
      })
    },
    _updateLinkStates: function () {
      ...
      d,
      e,
      f = this.commandMapping,
      g = this.actionMapping;
      for (c in f) e = f[c],
      this.commandsDisabled ? (d = !1, b.removeClass(e.link, 'wysihtml5-command-active'), e.group && b.removeClass(e.group, 'wysihtml5-command-active'), e.dialog && e.dialog.hide())  : (d = this.composer.commands.state(e.name, e.value), a.lang.object(d).isArray() && (d = 1 === d.length ? d[0] : !0), b.removeClass(e.link, 'wysihtml5-command-disabled'), e.group && b.removeClass(e.group, 'wysihtml5-command-disabled')),
      e.state !== d && ((e.state = d) ? (b.addClass(e.link, 'wysihtml5-command-active'), e.group && b.addClass(e.group, 'wysihtml5-command-active'), e.dialog && ('object' == typeof d ? e.dialog.show(d)  : e.dialog.hide()))  : (b.removeClass(e.link, 'wysihtml5-command-active'), e.group && b.removeClass(e.group, 'wysihtml5-command-active'), e.dialog && e.dialog.hide()));
      for (c in g) f = g[c],
      'change_view' === f.name && (f.state = this.editor.currentView === this.editor.textarea, f.state ? b.addClass(f.link, 'wysihtml5-action-active')  : b.removeClass(f.link, 'wysihtml5-action-active'))
    },
    show: function () {
...
function (a) {
  ...
  a.Editor = a.lang.Dispatcher.extend({
    constructor: function (c, d) {
      if (this.textareaElement = 'string' == typeof c ? document.getElementById(c)  : c, this.config = a.lang.object({
      }).merge(b).merge(d).get(), this.currentView = this.textarea = new a.views.Textarea(this, this.textareaElement, this.config), this._isCompatible = a.browser.supported(), !this._isCompatible || !this.config.supportTouchDevices && a.browser.isTouchDevice()) {
        var e = this;
        setTimeout(function () {
        ...
        this.currentView = this.composer = new a.views.Composer(this, this.textareaElement, this.config),
    ...
    _initParser: function () {
      this.observe('paste:composer', function () {
        ...
        b.composer.selection.executeAndRestore(function () {
          a.quirks.cleanPastedHTML(b.composer.element),
          b.parse(b.composer.element)
        }, !0)
      }),
  ...
  d = function (a, b) {
    ...
    function d(a) {
      ...
      a.registerHelper('each', function (a, b) {
        ...
        f = 0,
        g = '';
        if (m(a) && (a = a.call(this)), b.data && (c = q(b.data)), a && 'object' == typeof a) if (l(a)) for (var h = a.length; h > f; f++) c && (c.index = f, c.first = 0 === f, c.last = f === a.length - 1),
        g += d(a[f], {
          data: c
        });
         else for (var i in a) a.hasOwnProperty(i) && (c && (c.key = i, c.index = f, c.first = 0 === f), g += d(a[i], {
          data: c
        }), f++);
        return 0 === f && (g = e(this)),
        g
...
this.wysihtml5.tpl.blockquote = Handlebars.template(function (a, b, c, d, e) {
  ...
  l = this;
  return i += '<li>\n  <a class="btn ',
  h = c['if'].call(b, (g = b && b.options, null == g || g === !1 ? g : g.size), {
    hash: {
    },
    inverse: l.noop,
    fn: l.program(1, f, e),
  ...
  (h || 0 === h) && (i += h),
  i += ' btn-default" data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="blockquote" data-wysihtml5-display-format-name="false" tabindex="-1">\n    <span class="glyphicon glyphicon-quote"></span>\n  </a>\n</li>\n'
}),
...
this.wysihtml5.tpl.emphasis = Handlebars.template(function (a, b, c, d, e) {
  ...
  function g(a, b) {
    ...
    g = '';
    return g += '\n    <a class="btn ',
    e = c['if'].call(a, (d = a && a.options, null == d || d === !1 ? d : d.size), {
      hash: {
      },
      inverse: m.noop,
      fn: m.program(1, f, b),
    ...
    (e || 0 === e) && (g += e),
    g += ' btn-default" data-wysihtml5-command="small" title="CTRL+S" tabindex="-1">' + l((d = a && a.locale, d = null == d || d === !1 ? d : d.emphasis, d = null == d || d === !1 ? d : d.small, typeof d === k ? d.apply(a)  : d)) + '</a>\n    '
  }
  this.compilerInfo = [
    4,
    '>= 1.0.0'
  ...
  m = this;
  return j += '<li>\n  <div class="btn-group">\n    <a class="btn ',
  i = c['if'].call(b, (h = b && b.options, null == h || h === !1 ? h : h.size), {
    hash: {
    },
    inverse: m.noop,
    fn: m.program(1, f, e),
  ...
  (i || 0 === i) && (j += i),
  j += ' btn-default" data-wysihtml5-command="bold" title="CTRL+B" tabindex="-1">' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.emphasis, h = null == h || h === !1 ? h : h.bold, typeof h === k ? h.apply(b)  : h)) + '</a>\n    <a class="btn ',
  i = c['if'].call(b, (h = b && b.options, null == h || h === !1 ? h : h.size), {
    hash: {
    },
    inverse: m.noop,
  ...
  (i || 0 === i) && (j += i),
  j += ' btn-default" data-wysihtml5-command="italic" title="CTRL+I" tabindex="-1">' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.emphasis, h = null == h || h === !1 ? h : h.italic, typeof h === k ? h.apply(b)  : h)) + '</a>\n    <a class="btn ',
  i = c['if'].call(b, (h = b && b.options, null == h || h === !1 ? h : h.size), {
    hash: {
    },
    inverse: m.noop,
  ...
  (i || 0 === i) && (j += i),
  j += ' btn-default" data-wysihtml5-command="underline" title="CTRL+U" tabindex="-1">' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.emphasis, h = null == h || h === !1 ? h : h.underline, typeof h === k ? h.apply(b)  : h)) + '</a>\n    ',
...
this.wysihtml5.tpl.html = Handlebars.template(function (a, b, c, d, e) {
  ...
  (h || 0 === h) && (i += h),
  i += ' btn-default" data-wysihtml5-action="change_view" title="' + k((g = b && b.locale, g = null == g || g === !1 ? g : g.html, g = null == g || g === !1 ? g : g.edit, typeof g === j ? g.apply(b)  : g)) + '" tabindex="-1">\n      <span class="glyphicon glyphicon-pencil"></span>\n    </a>\n  </div>\n</li>\n'
}),
this.wysihtml5.tpl.image = Handlebars.template(function (a, b, c, d, e) {
  ...
  i = c['if'].call(b, (h = b && b.options, null == h || h === !1 ? h : h.smallmodals), {
    hash: {
    },
    inverse: m.noop,
    fn: m.program(1, f, e),
  ...
  (i || 0 === i) && (j += i),
  j += ' btn-default" data-wysihtml5-command="insertImage" title="' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.image, h = null == h || h === !1 ? h : h.insert, typeof h === k ? h.apply(b)  : h)) + '" tabindex="-1">\n    <span class="glyphicon glyphicon-picture"></span>\n  </a>\n</li>\n'
}),
this.wysihtml5.tpl.link = Handlebars.template(function (a, b, c, d, e) {
  ...
  (i || 0 === i) && (j += i),
  j += ' btn-default" data-wysihtml5-command="createLink" title="' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.link, h = null == h || h === !1 ? h : h.insert, typeof h === k ? h.apply(b)  : h)) + '" tabindex="-1">\n    <span class="glyphicon glyphicon-share"></span>\n  </a>\n</li>\n'
}),
this.wysihtml5.tpl.lists = Handlebars.template(function (a, b, c, d, e) {
  ...
  (h || 0 === h) && (i += h),
  i += ' btn-default" data-wysihtml5-command="insertUnorderedList" title="' + k((g = b && b.locale, g = null == g || g === !1 ? g : g.lists, g = null == g || g === !1 ? g : g.unordered, typeof g === j ? g.apply(b)  : g)) + '" tabindex="-1"><span class="glyphicon glyphicon-list"></span></a>\n    <a class="btn ',
  h = c['if'].call(b, (g = b && b.options, null == g || g === !1 ? g : g.size), {
    hash: {
    },
    inverse: l.noop,
  ...
  (h || 0 === h) && (i += h),
  i += ' btn-default" data-wysihtml5-command="insertOrderedList" title="' + k((g = b && b.locale, g = null == g || g === !1 ? g : g.lists, g = null == g || g === !1 ? g : g.ordered, typeof g === j ? g.apply(b)  : g)) + '" tabindex="-1"><span class="glyphicon glyphicon-th-list"></span></a>\n    <a class="btn ',
  h = c['if'].call(b, (g = b && b.options, null == g || g === !1 ? g : g.size), {
    hash: {
    },
    inverse: l.noop,
  ...
  (h || 0 === h) && (i += h),
  i += ' btn-default" data-wysihtml5-command="Outdent" title="' + k((g = b && b.locale, g = null == g || g === !1 ? g : g.lists, g = null == g || g === !1 ? g : g.outdent, typeof g === j ? g.apply(b)  : g)) + '" tabindex="-1"><span class="glyphicon glyphicon-indent-right"></span></a>\n    <a class="btn ',
  h = c['if'].call(b, (g = b && b.options, null == g || g === !1 ? g : g.size), {
    hash: {
    },
    inverse: l.noop,
  ...
  (h || 0 === h) && (i += h),
  i += ' btn-default" data-wysihtml5-command="Indent" title="' + k((g = b && b.locale, g = null == g || g === !1 ? g : g.lists, g = null == g || g === !1 ? g : g.indent, typeof g === j ? g.apply(b)  : g)) + '" tabindex="-1"><span class="glyphicon glyphicon-indent-left"></span></a>\n  </div>\n</li>\n'
}),
'object' == typeof exports && exports && (module.exports = this.wysihtml5.tpl),
!function (a, b) {
  'use strict';
  ...
  d = function (c, d) {
    ...
    this.toolbar = this.createToolbar(c, e),
    this.editor = this.createEditor(e),
    window.editor = this.editor,
    a('iframe.wysihtml5-sandbox').each(function (b, c) {
  ...
  d.prototype = {
    ...
    createToolbar: function (b, d) {
      ...
      for (var k in d) {
        var l = !1;
        void 0 !== d[k] ? d[k] === !0 && (l = !0)  : l = f[k],
        l === !0 && (h.append(c(k, j, d)), 'html' === k && this.initHtml(h), 'link' === k && this.initInsertLink(h), 'image' === k && this.initInsertImage(h))
      }
    ...
    initInsertImage: function (b) {
      ...
      i = function () {
        ...
        c && (d.editor.composer.selection.setBookmark(c), c = null),
        d.editor.composer.commands.exec('insertImage', a)
      };
  ...
  var e = {
    ...
    shallowExtend: function (b) {
      ...
      d = this;
      return e.bypassDefaults.apply(d, [
        c
      ])
    },
    ...
    init: function (a) {
      var b = this;
      return e.shallowExtend.apply(b, [
        a
      ])
    }
  };
  ...
  'undefined' == typeof a.fn.wysihtml5.defaultOptionsCache && (a.fn.wysihtml5.defaultOptionsCache = a.extend(!0, {
